              ...
              <div className="aem-GridColumn aem-GridColumn--default--5 aem-GridColumn--phone--12">
                <div className="productdetails__right">
                  ...
                  <div className="productdetails__right-share">
                    <ul>
                      <li><button className="secondary-button"><img src={heart} /> Save</button></li>
                      <li><button className="secondary-button" onClick={handleShow}><i className="fa fa-share-alt" aria-hidden="true"></i> Share</button>
